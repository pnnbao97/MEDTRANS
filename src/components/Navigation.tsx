        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            ...
            <div className="hidden md:ml-6 md:flex md:space-x-6">
              <Link
                to="/"
                className="inline-flex items-center px-1 pt-1 border-b-2 border-teal-500 text-sm font-medium text-gray-900"
              >
      ...
      <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden`}>
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          ...
          <div className="mt-3 px-2 space-y-1">
            <button className="w-full flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-teal-600 hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500">
              Đăng nhập
            </button>
          </div>
        </div>
